...
class ContinuousFeatureGenerator:
    ...
    def __init__(self, num_feature):
        self.num_feature = num_feature
        # sys.maxint remove in python 3, using sys.maxsize instead.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_dir",
        type=str,
        default="E:/Code/CTRModels/data/",
        help="input data dir"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="E:/Code/CTRModels/output/",
